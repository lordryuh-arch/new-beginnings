    ...
    <div style={{
      ...
      <div className="idle-grid" style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, minHeight: 0, overflowY: "auto" }}>
          ...
          <Panel title="MAPA ATUAL">
            <div style={{ padding: 20, textAlign: 'center', color: '#f5cf6b' }}>
              <p>O mapa original está em manutenção.</p>
              <p>Use o botão 🗺️ MUNDO acima para navegar.</p>
            </div>
          </Panel>
