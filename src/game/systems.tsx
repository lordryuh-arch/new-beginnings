...
import iconPokeballAsset from "@/assets/items/icon-pokeball.png.asset.json";
...
import iconSafariballAsset from "@/assets/items/icon-safariball.png.asset.json";
...
import iconReviveAsset from "@/assets/items/icon-revive.png.asset.json";
const iconRevive = assetUrlFromJson(iconReviveAsset);
import iconIncenseAsset from "@/assets/incense-24h.png.asset.json";
const iconIncense = assetUrlFromJson(iconIncenseAsset);
import iconVipAsset from "@/assets/ruby-vip.jpg.asset.json";
