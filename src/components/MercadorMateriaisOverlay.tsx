...
import imgOuroAsset from "@/assets/materials/ouro.png.asset.json";
const imgOuro = assetUrlFromJson(imgOuroAsset);
...
import imgPerolaAsset from "@/assets/materials/perola.png.asset.json";
const imgPerola = assetUrlFromJson(imgPerolaAsset);
import imgMorangoAsset from "@/assets/materials/morango.png.asset.json";
const imgMorango = assetUrlFromJson(imgMorangoAsset);
import imgChicoteAsset from "@/assets/materials/chicote.png.asset.json";
const imgChicote = assetUrlFromJson(imgChicoteAsset);
import imgEscamasAsset from "@/assets/materials/escamas.png.asset.json";
const imgEscamas = assetUrlFromJson(imgEscamasAsset);
import imgAguaAsset from "@/assets/materials/agua.png.asset.json";
const imgAgua = assetUrlFromJson(imgAguaAsset);
import imgCrPrismaAsset from "@/assets/materials/cristal-prisma.png.asset.json";
const imgCrPrisma = assetUrlFromJson(imgCrPrismaAsset);
import imgCrRedAsset from "@/assets/materials/cristal-red.png.asset.json";
const imgCrRed = assetUrlFromJson(imgCrRedAsset);
import imgCrBlueAsset from "@/assets/materials/cristal-blue.png.asset.json";
const imgCrBlue = assetUrlFromJson(imgCrBlueAsset);
import imgCrYellowAsset from "@/assets/materials/cristal-yellow.png.asset.json";
const imgCrYellow = assetUrlFromJson(imgCrYellowAsset);
import imgCrGreenAsset from "@/assets/materials/cristal-green.png.asset.json";
const imgCrGreen = assetUrlFromJson(imgCrGreenAsset);
import imgCrPurpleAsset from "@/assets/materials/cristal-purple.png.asset.json";
const imgCrPurple = assetUrlFromJson(imgCrPurpleAsset);
import imgCogRedAsset from "@/assets/materials/cogumelo-red.png.asset.json";
const imgCogRed = assetUrlFromJson(imgCogRedAsset);
import imgCogBrownAsset from "@/assets/materials/cogumelo-brown.png.asset.json";
const imgCogBrown = assetUrlFromJson(imgCogBrownAsset);
import imgCogBlueAsset from "@/assets/materials/cogumelo-blue.png.asset.json";
const imgCogBlue = assetUrlFromJson(imgCogBlueAsset);
