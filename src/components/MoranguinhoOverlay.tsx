...
import imgBuqueAsset from "@/assets/materials/buque.png.asset.json";
const imgBuque = assetUrlFromJson(imgBuqueAsset);
import imgFlorRedAsset from "@/assets/materials/flor-red.png.asset.json";
const imgFlorRed = assetUrlFromJson(imgFlorRedAsset);
import imgFlorBlueAsset from "@/assets/materials/flor-blue.png.asset.json";
const imgFlorBlue = assetUrlFromJson(imgFlorBlueAsset);
import imgFlorPurpleAsset from "@/assets/materials/flor-purple.png.asset.json";
const imgFlorPurple = assetUrlFromJson(imgFlorPurpleAsset);
